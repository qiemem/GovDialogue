...
<form name="newPostForm" id="newPostForm" method="POST" action="addpost.php">
    ...
    <p><textarea name="content" id="content" rows="15" cols="70" onfocus="if(this.value=='Write your post here'){this.value='';}" onblur="if(this.value==''){this.value='Write your post here';}">Write your post here</textarea></p>
